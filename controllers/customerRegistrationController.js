...
async function generateCustomerPDF(customerData, outputStream) {
    return new Promise((resolve, reject) => {
        try {
            ...
            // Header Section
            doc.rect(0, 0, 595, 80).fill("#040F28");
            doc.fillColor("#ffffff").font("Helvetica-Bold").fontSize(24).text("CARZISE", 50, 30);

            // Company Logo
            const iconPath = path.join(__dirname, "../public/img/logo.png");
            ...
            QRCode.toBuffer(
                ...
                .then(qrCodeBuffer => {
                    ...
                    doc.rect(0, 750, 595, 50).fill("#040F28");
                    doc.fillColor("#ffffff").fontSize(10).text("Created by Carzise.", 50, 765);
                    doc.text("Email: Carzisee@gmail.com", 50, 780);
